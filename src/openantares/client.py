...
class Alpha:
    ...
    environment : AlphaEnvironment
        The environment to use for requests from the client. from .environment import AlphaEnvironment



        Defaults to AlphaEnvironment.PRODUCTION
    ...
    def __init__(
        ...
        *,
        ...
        environment: AlphaEnvironment = AlphaEnvironment.PRODUCTION,
...
def _get_base_url(*, base_url: typing.Optional[str] = None, environment: AlphaEnvironment) -> str:
